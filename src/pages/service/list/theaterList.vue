      ...
      <div class="good-list">
        <div @click="godetail(item)"
          ...
          <div class="good-detail">
            ...
            <div class="good-sell">
              <div class="buy-num">{{item.salesNum}}人已购买</div>
              <div class="price-num">
...
export default {
  ...
  methods: {
    godetail (item) {
      this.$router.push("/detail/theater?id=" + item.id);
    },
    search () {
    ...
    upCallback (page, mescroll) {
      this.getAxios("/merchant/api/theater/merchantTheaterShowGrid", {
        currPage: page.num,
        pageSize: page.size,
        orderType: false,
